...
<span><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentcolor"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414.0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414.0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/></svg></span><label><select name=theme class="absolute appearance-none inset-0 w-full h-full opacity-0 dark:text-slate-500" @change.debounce=toggleTheme($event.target.value)><option value=none selected disabled hidden>default</option><option value=light>Light</option><option value=dark>Dark</option></select></label></div></div></div></div></div></div><main><div class="container mx-auto xl:max-w-screen-xl mt-8 px-2 flex justify-between space-x-5"><div class="w-full md:w-3/4"><div class=space-y-5><h1 class="text-2xl font-bold dark:text-slate-300">删除文件夹中的node_modules子文件夹</h1><div class="flex text-sm space-x-5"><span class="flex items-center space-x-1"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentcolor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5A2 2 0 003 7v12a2 2 0 002 2z"/></svg><time>2021-09-18</time></span><ul class="flex items-center space-x-2"><li class="px-1 py-0.5 rounded text-white bg-emerald-500"><a href=https://zhujianghan.github.io/zjh-blog/tags/go>go</a></li></ul></div><div x-data="{
        theme: localStorage.theme === 'dark' ? 'dark' : 'light'
      }"><article class=markdown-body :class="{ 'markdown-body-light': theme === 'light', 'markdown-body-dark': theme === 'dark',  }"><div class=highlight><pre tabindex=0 style=color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4><code class=language-golang data-lang=golang><span style=display:flex><span><span style=color:#f92672>package</span> <span style=color:#a6e22e>main</span>
...
</span></span><span style=display:flex><span>	<span style=color:#66d9ef>if</span> len(<span style=color:#a6e22e>os</span>.<span style=color:#a6e22e>Args</span>) <span style=color:#f92672>==</span> <span style=color:#ae81ff>1</span> {
</span></span><span style=display:flex><span>		panic(<span style=color:#e6db74>&#34;Enter a file name&#34;</span>)
</span></span><span style=display:flex><span>	}
</span></span><span style=display:flex><span>	<span style=color:#a6e22e>src</span> <span style=color:#f92672>:=</span> <span style=color:#a6e22e>os</span>.<span style=color:#a6e22e>Args</span>[<span style=color:#ae81ff>1</span>]
</span></span><span style=display:flex><span>
</span></span><span style=display:flex><span>	<span style=color:#66d9ef>var</span> <span style=color:#a6e22e>pathList</span> []<span style=color:#66d9ef>string</span>
</span></span><span style=display:flex><span>
</span></span><span style=display:flex><span>	<span style=color:#a6e22e>err</span> <span style=color:#f92672>:=</span> <span style=color:#a6e22e>filepath</span>.<span style=color:#a6e22e>Walk</span>(<span style=color:#a6e22e>src</span>, <span style=color:#66d9ef>func</span>(<span style=color:#a6e22e>path</span> <span style=color:#66d9ef>string</span>, <span style=color:#a6e22e>info</span> <span style=color:#a6e22e>fs</span>.<span style=color:#a6e22e>FileInfo</span>, <span style=color:#a6e22e>err</span> <span style=color:#66d9ef>error</span>) <span style=color:#66d9ef>error</span> {
</span></span><span style=display:flex><span>
</span></span><span style=display:flex><span>		<span style=color:#66d9ef>if</span> <span style=color:#a6e22e>err</span> <span style=color:#f92672>!=</span> <span style=color:#66d9ef>nil</span> {
</span></span><span style=display:flex><span>			<span style=color:#66d9ef>return</span> <span style=color:#a6e22e>err</span>
</span></span><span style=display:flex><span>		}
</span></span><span style=display:flex><span>
</span></span><span style=display:flex><span>		<span style=color:#66d9ef>if</span> <span style=color:#a6e22e>info</span>.<span style=color:#a6e22e>IsDir</span>() <span style=color:#f92672>&amp;&amp;</span> <span style=color:#a6e22e>info</span>.<span style=color:#a6e22e>Name</span>() <span style=color:#f92672>==</span> <span style=color:#e6db74>&#34;node_modules&#34;</span> {
...
</span></span><span style=display:flex><span>		<span style=color:#a6e22e>path</span> = <span style=color:#a6e22e>filepath</span>.<span style=color:#a6e22e>ToSlash</span>(<span style=color:#a6e22e>path</span>)
</span></span><span style=display:flex><span>		<span style=color:#a6e22e>pathList</span> = append(<span style=color:#a6e22e>pathList</span>, <span style=color:#a6e22e>path</span>)
</span></span><span style=display:flex><span>
</span></span><span style=display:flex><span>		<span style=color:#66d9ef>return</span> <span style=color:#66d9ef>nil</span>
</span></span><span style=display:flex><span>	})
</span></span><span style=display:flex><span>
</span></span><span style=display:flex><span>	<span style=color:#66d9ef>if</span> <span style=color:#a6e22e>err</span> <span style=color:#f92672>!=</span> <span style=color:#66d9ef>nil</span> {
</span></span><span style=display:flex><span>		<span style=color:#a6e22e>fmt</span>.<span style=color:#a6e22e>Printf</span>(<span style=color:#e6db74>&#34;filepath.Walk() returned %v\n&#34;</span>, <span style=color:#a6e22e>err</span>)
</span></span><span style=display:flex><span>		panic(<span style=color:#a6e22e>err</span>)
</span></span><span style=display:flex><span>	}
</span></span><span style=display:flex><span>
</span></span><span style=display:flex><span>	<span style=color:#66d9ef>for</span> <span style=color:#a6e22e>index</span>, <span style=color:#a6e22e>path</span> <span style=color:#f92672>:=</span> <span style=color:#66d9ef>range</span> <span style=color:#a6e22e>pathList</span> {
</span></span><span style=display:flex><span>		<span style=color:#a6e22e>fmt</span>.<span style=color:#a6e22e>Println</span>(<span style=color:#a6e22e>index</span><span style=color:#f92672>+</span><span style=color:#ae81ff>1</span>, <span style=color:#e6db74>&#34;/&#34;</span>, len(<span style=color:#a6e22e>pathList</span>), <span style=color:#e6db74>&#34;:  &#34;</span>, <span style=color:#a6e22e>path</span>)
</span></span><span style=display:flex><span>
</span></span><span style=display:flex><span>		<span style=color:#a6e22e>err</span> = <span style=color:#a6e22e>customCopy</span>(<span style=color:#a6e22e>path</span>)
</span></span><span style=display:flex><span>		<span style=color:#66d9ef>if</span> <span style=color:#a6e22e>err</span> <span style=color:#f92672>!=</span> <span style=color:#66d9ef>nil</span> {
</span></span><span style=display:flex><span>			panic(<span style=color:#a6e22e>err</span>)
</span></span><span style=display:flex><span>		}
</span></span><span style=display:flex><span>	}
...
</span></span><span style=display:flex><span><span style=color:#66d9ef>func</span> <span style=color:#a6e22e>customCopy</span>(<span style=color:#a6e22e>src</span> <span style=color:#66d9ef>string</span>) <span style=color:#66d9ef>error</span> {
</span></span><span style=display:flex><span>	<span style=color:#a6e22e>dst</span> <span style=color:#f92672>:=</span> <span style=color:#e6db74>&#34;./bak-&#34;</span> <span style=color:#f92672>+</span> <span style=color:#a6e22e>src</span>
</span></span><span style=display:flex><span>
</span></span><span style=display:flex><span>	<span style=color:#a6e22e>dir</span> <span style=color:#f92672>:=</span> <span style=color:#a6e22e>path</span>.<span style=color:#a6e22e>Dir</span>(<span style=color:#a6e22e>dst</span>)
</span></span><span style=display:flex><span>
</span></span><span style=display:flex><span>	<span style=color:#a6e22e>_</span>, <span style=color:#a6e22e>err</span> <span style=color:#f92672>:=</span> <span style=color:#a6e22e>os</span>.<span style=color:#a6e22e>Stat</span>(<span style=color:#a6e22e>dir</span>)
</span></span><span style=display:flex><span>	<span style=color:#66d9ef>if</span> <span style=color:#a6e22e>err</span> <span style=color:#f92672>!=</span> <span style=color:#66d9ef>nil</span> {
...
</span></span><span style=display:flex><span>			<span style=color:#a6e22e>err</span> = <span style=color:#a6e22e>os</span>.<span style=color:#a6e22e>MkdirAll</span>(<span style=color:#a6e22e>dir</span>, <span style=color:#ae81ff>0777</span>)
</span></span><span style=display:flex><span>			<span style=color:#66d9ef>if</span> <span style=color:#a6e22e>err</span> <span style=color:#f92672>!=</span> <span style=color:#66d9ef>nil</span> {
</span></span><span style=display:flex><span>				panic(<span style=color:#a6e22e>err</span>)
</span></span><span style=display:flex><span>			}
...
</span></span></code></pre></div></article><link rel=stylesheet href=https://unpkg.com/gitalk/dist/gitalk.css><script src=https://unpkg.com/gitalk/dist/gitalk.min.js></script><div id=gitalk-container></div><script>const gitalk=new Gitalk({clientID:'af53f77dab68cdae8778',clientSecret:'469a082952a22532658000e23d2064d7a9135756',repo:'zjh-blog',owner:'zhujianghan',admin:['zhujianghan'],id:"b8f0b080b022cc94e7f29b9bdd2fc626",distractionFreeMode:!1});gitalk.render('gitalk-container')</script></div></div></div><div class="hidden md:block md:w-1/4"><div class="p-4 border-l rounded space-y-10"><div><div class=font-bold>TOC</div><div class=pl-2><nav id=TableOfContents></nav></div></div><div><div class=font-bold>Recent Posts</div><ul class="pl-2 space-y-2"><li><a href=https://zhujianghan.github.io/zjh-blog/posts/server/rsync-and-screen-to-backup-data-in-linux/ class="text-sm line-clamp-1" title="rsync & screen to backup data in linux">rsync & screen to backup data in linux</a></li><li><a href=https://zhujianghan.github.io/zjh-blog/posts/backend/gorm-deleted-at-issue/ class="text-sm line-clamp-1" title="Gorm deleted at 与 unique 索引问题">Gorm deleted at 与 unique 索引问题</a></li><li><a href=https://zhujianghan.github.io/zjh-blog/posts/server/mysql-clear-binlog/ class="text-sm line-clamp-1" title="mysql8.4 清空 binlog 并重置序号">mysql8.4 清空 binlog 并重置序号</a></li><li><a href=https://zhujianghan.github.io/zjh-blog/posts/server/linux-smb-service-configuration/ class="text-sm line-clamp-1" title="linux 设置 smb">linux 设置 smb</a></li><li><a href=https://zhujianghan.github.io/zjh-blog/posts/other/dell-install-win11-by-ventoy/ class="text-sm line-clamp-1" title="dell 用 ventoy 安装 win11 失败">dell 用 ventoy 安装 win11 失败</a></li></ul></div><div><div class=font-bold>Tags</div><ul class=pl-2><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/7z/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>7z</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/apache/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>apache</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">4</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/axios/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>axios</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/benchmark/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>benchmark</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/binlog/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>binlog</span>
...
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">3</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/channel/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>channel</span>
...
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/css/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>css</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">2</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/databse/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>databse</span>
...
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">4</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/fail2ban/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>fail2ban</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/frp/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>frp</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/gin/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>gin</span>
...
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">21</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/mermaid/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>mermaid</span>
...
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">11</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/nginx/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>nginx</span>
...
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">8</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/rsync/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>rsync</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/screen/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>screen</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/server/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>server</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/smb/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>smb</span>
...
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">2</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/tarojs/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>tarojs</span>
...
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/token/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>token</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/ubuntu/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>ubuntu</span>
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/ufw/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>ufw</span>
...
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">1</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/ventoy/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>ventoy</span>
...
<span class="px-2 text-xs rounded-full text-slate-100 bg-emerald-500">2</span></a></li><li class="inline-block mt-3 mr-2"><a href=https://zhujianghan.github.io/zjh-blog/tags/vscode/ class="px-2 py-1 rounded bg-slate-200 dark:bg-slate-600"><span class=text-sm>vscode</span>
